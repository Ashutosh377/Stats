...
SELECT 
    LPAD(CONVERT( Garage_Size , CHAR), 4, '0')
FROM
    property_price_train_new;

#Q4.Write a MySQL query to print the observations from the columns “Brick_Veneer_Area” and “Brick_Veneer_Type” of the table “Property_Price_Train_new”,
# excluding the values “None” And “BrkCmn” from the column “Brick_Veneer_Type”.
...
#Q6.Write a MySQL query to print the observations of the table “Property_Price_Train_new” where the values of the 
#column “Brick_Veneer_Type” ends with “e” and contains 4 alphabets.
